          ...
          {backgroundMode === 'motivational-motion' ? (
            ...
            <>
              <motion.div
                ...
                className={`absolute top-0 left-0 w-full h-full bg-gradient-to-br ${selectedBackground.colors.primary} opacity-20`}
              />
              <motion.div
                animate={{
                  scale: [1.2, 1, 1.2],
                ...
                className={`absolute top-0 left-0 w-full h-full bg-gradient-to-br ${selectedBackground.colors.secondary} opacity-20`}
              />
            </>
          ) : (
